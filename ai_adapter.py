...
async def generate_video_script(post_text: str, article_title: str, lang: str = "en") -> str:
    ...
    if lang == "ru":
        ...
        user_message = (
            ...
            "  1. [Крючок — 1 предложение] — ШОКИРУЮЩИЙ ФАКТ, цифра или сюрприз. Никогда не начинай с названия игры.\n"
        ...
        user_message = (
            ...
            "  1. [Hook — 1 sentence] — a SHOCKING FACT, number, or reveal. NEVER start with the game name.\n"
